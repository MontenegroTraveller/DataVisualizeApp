      ...
      <ConnectedRouter history={history} location={props.location} context={props.context}>
        <StartupConnected>
          <Switch>
            ...
            <Route exact path="/bar_chart" component={() => <App />} />
            <Route exact path="/scatter" component={() => <App />} />
            <Route exact path="/cluster" component={() => <App />} />
            <Route exact path="/word_cloud" component={() => <App />} />
